...
public class FirstScene : Scene
{
	protected override void Start()
	{
		...
		GameWindow.SetBackgroundColor(new Color(20, 20, 35));
	...
	protected override void BuildUI(RootElement root)
	{
		...
		root.AddChild(panel); // root, permet d'accèder à l'UIElement principal de notre scène.
		...
		layout.AddChild(new Label("Ma première scène !"));
